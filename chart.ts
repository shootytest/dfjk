...
export class Chart {
  ...
  finish() {
    ...
    if ((Sound.current?.element?.playbackRate ?? 0) >= 1) {
      ...
      scores.save();
      if (firebase.user?.uid) firebase.save_scores(firebase.user.uid); // save
    }
  }
...
export const chart_definitions: { [key: string]: chart_def } = {
  ...
  saloon_4: {
    ...
    notes: [
      ...
      [ note_type.normal, 2, 116.2 ],
      [ note_type.normal, 3, 116.6 ],
      [ note_type.normal, 2, 117.0 ],
      [ note_type.normal, 3, 117.4 ],
      [ note_type.normal, 2, 117.8 ],
      [ note_type.normal, 3, 118.2 ],
      [ note_type.normal, 2, 118.6 ],
      [ note_type.normal, 3, 119.0 ],
      [ note_type.normal, 2, 119.4 ],
      [ note_type.normal, 3, 119.8 ],
      [ note_type.normal, 2, 120.2 ],
      [ note_type.normal, 3, 120.6 ],
      ...
      [ note_type.none,   0, 1000000, 60000 / 486 ],
      [ note_type.hold,   1, 138, 4 ],
      [ note_type.hold,   2, 138, 4 ],
      [ note_type.hold,   3, 138, 4 ],
      [ note_type.hold,   4, 138, 4 ],
