...
export const chart_definitions: { [key: string]: chart_def } = {
  ...
  dusk_1: {
    ...
    notes: [
      ...
      [ note_type.normal, 4, 4, 16 ],
      [ note_type.normal, 4, 12, 16 ],
      [ note_type.hold,   3, 16, 16 ],
      [ note_type.normal, 1, 20, 16 ],
      [ note_type.normal, 1, 30, 16 ],
      [ note_type.hold,   2, 32, 16 ],
      [ note_type.normal, 4, 36, 16 ],
      [ note_type.normal, 4, 44, 16 ],
      [ note_type.hold,   3, 48, 16 ],
      [ note_type.normal, 1, 52, 16 ],
      [ note_type.normal, 1, 62, 16 ],
      [ note_type.hold,   4, 64, 16 ],
      [ note_type.normal, 2, 68, 16 ],
      [ note_type.normal, 2, 76, 16 ],
      [ note_type.hold,   1, 80, 16 ],
      [ note_type.normal, 3, 84, 16 ],
      [ note_type.normal, 3, 94, 16 ],
      [ note_type.hold,   2, 96, 16 ],
      [ note_type.normal, 4, 100, 16 ],
      [ note_type.normal, 4, 108, 16 ],
      [ note_type.hold,   3, 112, 16 ],
      [ note_type.normal, 1, 116, 16 ],
      // [ note_type.normal, 1, 118, 16 ],
      [ note_type.normal, 1, 126, 16 ],
