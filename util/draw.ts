...
export class Context {
  ...
  set_font_mono(size: number, prefix: string = "", align: CanvasTextAlign = "center") {
    this.ctx.font = `${prefix} ${Math.floor(size)}px roboto mono`.trim();
    this.textAlign = align;
    this.textBaseline = "middle";
  }

  set_font_condensed(size: number, prefix: string = "", align: CanvasTextAlign = "center") {
    this.ctx.font = `${prefix} ${Math.floor(size)}px roboto condensed`.trim();
    this.textAlign = align;
    this.textBaseline = "middle";
  }

  draw_image(image: HTMLImageElement, x: number, y: number, w: number, h: number) {
